...
import { Abouts, AboutData, AboutTitle, AboutSubtitle, AboutFilters, AboutButton, AboutContainer, AboutImage, Image } from "./About.styles";
...
const handleButtonClick = (option: string) => {
    ...
    return (
        <Abouts className={styles.container}>
            <AboutContainer>
                <AboutData>
                ...
                {aboutOption === "option1" && (
                    ...
                    creative minds in design, web design and marketing, with
                    global reach, paving the way for more creative easy, quick and
                    efficient
                    </p>
                )}{" "}
                </>
                ...
                {aboutOption === "option3" && (
                    ...
                    art and driven by solving challenges. With more than 5 years
                    of expertise, we follow the path of brand development and
                    implementation in the digital universe. Join us and witness
                    the passion that we infuse into each project
                    </p>
                )}{" "}
                </>
                </AboutData>
